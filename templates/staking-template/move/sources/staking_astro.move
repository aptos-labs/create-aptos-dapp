...
//
//         // current schedule has finished, time to find next schedule
...
//                     // we found a schedule that is active because it's end time is greater than current block time
...
//             simple_map::add(
//                 &mut stake_pool.finished_reward_indexes,
//                 block_ts,
//                 reward_info.index)
//         };
...
//         };
//
//         // TODO: test do we need to empty all schedules then add to_save? and do we need to sort it by end time?
